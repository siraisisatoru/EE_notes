...
extern void reboot();
const byte keyMap[6][2] = {{KEY_1,0}, {KEY_2,0}, {KEY_3,0}, {KEY_4,0}, {KEY_ARROW_UP,0}, {KEY_ARROW_DOWN, 0}};
const byte seckeyMap[6][2] = {{KEY_ENTER, 0}, {KEY_ENTER, 0}, {KEY_ENTER, 0}, {KEY_ENTER, 0}, {0, 0}, {0, 0}};
